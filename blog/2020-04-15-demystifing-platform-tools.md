...
#### Resources
* Learn Terraform from my tutorial [Introducing Infrastructure as Code](http://steven-rutherford.com/docs/tracks/devops/introduction-to-infrastructure-as-code)
